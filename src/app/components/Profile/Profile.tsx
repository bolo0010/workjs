...
import {Accordion, Button, Card, Col, Container, Row, Stack, Tab, Tabs} from "react-bootstrap";
import './Profile.css'
import {TechnologyInProfile} from "../../../types/interfaces";
                            ...
                            <Accordion>
                                {
                                    technologies.map(technology => (
                                        <Accordion.Item eventKey={technology.id.toString()} key={`technology_in_profile_${technology.id}`}>
        ...
        <div className="profile">
            <Stack direction='vertical'>
                ...
                <Stack direction='horizontal' className='position-absolute top-0 end-0'>
                    <Button className='profile__button btn-sm' variant="primary">Edytuj profil</Button>
                    <Button className='profile__button btn-sm' variant="primary">Dodaj projekt</Button>
